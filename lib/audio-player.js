...
class AudioPlayer {
  ...
  /**
   * Enable/disable Crossfading for iOS only
   */

  crossfadeInEnabled(enable) {
    this.log('client called crossfadeInEnabled =' + enable);

    if (Platform.OS === 'ios') {
      RNFMAudioPlayer.crossfadeInEnabled(enable);
    }
  }
